...
namespace FifaBestSquad
{
    ...
    {
        public List<ClubTeamStat> clubTeamStats { get; set; }
        public List<NationalTeamStat> nationalTeamStats { get; set; }
